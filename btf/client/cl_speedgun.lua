                ...
                if IsPlayerFreeAiming(PlayerId()) then
                    ...
                    if getaimeentity ~= 0 then
                        ...
                        if entityspeed > 100 and lastentityvehicle ~= vehicleplate then
                            ...
                            TriggerServerEvent("BTF:speedGunFinePlayer", GetPlayerServerId(NetworkGetPlayerIndexFromPed(aimeentity)), entityspeed)
                            ...
                            if lastentityvehicle == vehicleplate then
                                ...
                                Notify("~r~This player was fined to recently!")
...
RegisterNetEvent('BTF:speedGunPlayerFined')
AddEventHandler('BTF:speedGunPlayerFined', function()
    PlaySoundFrontend(-1, "ScreenFlash", "MissionFailedSounds", 1)
    StartScreenEffect("FocusOut", 0, false)
    Wait(2000)
    StopScreenEffect("FocusOut")
