...
local Housing = module("BTF-Core", "cfg/cfg_homes")
local inHome = false
...
RMenu.Add("JudHousing", "main", RageUI.CreateMenu("", "", 1350, 50,"banners","homes"))
RMenu.Add("JudHousing", "leave", RageUI.CreateMenu("", "", 1350, 50,"banners","homes"))
RMenu.Add("JudHousing", "wardrobe", RageUI.CreateMenu("", "~b~Wardrobe", 1350, 50,"hobannersme","homes"))
RMenu.Add("JudHousing", "wardrobesub", RageUI.CreateSubMenu(RMenu:Get("JudHousing", "wardrobe"), "", "~b~Wardrobe", 1350, 50,"banners","homes"))
        ...
        for k, v in pairs(cfghomes.homes) do
            ...
            if currentHome == k then
                ...
                if isInArea(v.chest_point, 0.8) and inHome then
                    alert("~g~Press ~INPUT_VEH_HORN~ To Open House Chest!")
                ...
                if inHome then
                    DrawMarker(9, v.wardrobe_point, 0.0, 0.0, 0.0, 90.0, 0.0, 0.0, 0.5, 0.5, 0.5, 0, 0, 255, 60, true, true, 2, false, "clothing", "clothing", false)
                end
