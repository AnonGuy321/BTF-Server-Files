...
RMenu.Add("SmallArmsMenu", "main", RageUI.CreateMenu("", "~r~BTF Small Arms", 1300, 50, "banners", "small"))
RMenu.Add("SmallArmsMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("SmallArmsMenu", "main"), "", "~r~BTF Small Arms", 1300, 50, "banners", "small"))
RMenu.Add("SmallArmsMenu", "whitelisted", RageUI.CreateSubMenu(RMenu:Get("SmallArmsMenu", "main"), "", "~r~BTF Small Arms", 1300, 50, "banners", "small"))
RageUI.CreateWhile(1.0, RMenu:Get("SmallArmsMenu", "main"), nil, function()
    ...
    RageUI.IsVisible(RMenu:Get("SmallArmsMenu", "whitelisted"), true, false, true, function()
        ...
        RageUI.Button("Buy Max Ammo", "Purchase Max Ammo for "..currentGunName1, { RightLabel = "~g~£"..getMoneyStringFormatted(currentGunPrice1 / 2) }, true, function(Hovered, Active, Selected)
            if Selected then
    ...
    while true do
        ...
        for k, v in pairs(smallarms.gunshops) do
            ...
            if isInArea(v, 1.4) and isInSmallarms == false then 
                alert("Press ~INPUT_VEH_HORN~ to access ~r~Small Arms")
