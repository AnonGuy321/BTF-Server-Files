...
RegisterNetEvent("BTF:EntityCleanupGun")
AddEventHandler("BTF:EntityCleanupGun", function()
    ...
    if EntityCleanupGun then 
        ...
        tBTF.notify("~g~Entity cleanup gun enabled.")
    else 
        tBTF.notify("~r~Entity cleanup gun disabled.")
