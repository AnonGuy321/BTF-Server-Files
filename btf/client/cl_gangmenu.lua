...
AddEventHandler("playerSpawned",function()
    local h = true
    if h then 
        TriggerServerEvent("BTF:GetGangData")
    end 
end)
RegisterNetEvent("BTF:GotGangData")
AddEventHandler("BTF:GotGangData",function(i,j,k,PO)
    if i==nil then 
        PlayerIsInGang=false 
    else 
        PlayerIsInGang=true
...
RegisterNetEvent("BTF:disbandedGang")
AddEventHandler("BTF:disbandedGang",function()
    PlayerIsInGang=false
    showGangUI=false
    showNoGangUI=true
    ...
    TriggerEvent("BTF:ForceRefreshData")
end)
RegisterNetEvent("BTF:ForceRefreshData")
AddEventHandler("BTF:ForceRefreshData",function()
    TriggerServerEvent("BTF:GetGangData")
end)
RegisterNetEvent("BTF:InviteRecieved")
AddEventHandler("BTF:InviteRecieved",function(o,Q)
    BTFGangInvites[BTFGangInviteIndex]=Q
    BTFGangInviteIndex=BTFGangInviteIndex+1
    tBTF.notify(o)
end)
RegisterNetEvent("BTF:gangNameNotTaken")
AddEventHandler("BTF:gangNameNotTaken",function()
    showNoGangUI=false
    showGangUI=true
    PlayerIsInGang=true 
end)
function func_drawGangUI()
    if showNoGangUI then 
        ...
        DrawAdvancedText(0.558,0.303,0.005,0.0028,0.539,"BTF Gangs",255,255,255,255,7,0)
        ...
        for p,q in pairs(BTFGangInvites)do 
        ...
        if CursorInArea(0.35,0.415,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if createGangName~=nil and createGangName~="null"and createGangName~=""then 
                    TriggerServerEvent("BTF:CreateGang",createGangName)
                else 
                    tBTF.notify("~r~No gang name entered!")
                end 
            end 
        else 
            CreateGangSelectionRed=0
        ...
        if CursorInArea(0.435,0.51,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedGangInvite~=nil then 
                    selectedGangInvite=BTFGangInvites[selectedGangInvite]
                    local perm1s = tBTF.getUserId()
                    TriggerServerEvent("BTF:addUserToGang",selectedGangInvite,perm1s)
                    BTFGangInvites={}
                    showNoGangUI=false
                    BTFGangInviteIndex=0
                    showGangUI=true
                    ...
                    tBTF.notify("~r~No gang invite selected")
                end 
            end 
        else 
            JoinGangSelectionRed=0
    ...
    if showFundsGangUI then 
        ...
        DrawRect(0.501, 0.374, 0.421, 0.047, 255, 255, 0, 248)
        DrawAdvancedText(0.591,0.378,0.005,0.0028,0.48,"BTF Gang - Funds",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1, 329) or IsDisabledControlJustPressed(1, 329) then
                ...
                if amount ~= nil then
                    if closeToBarclays() then
                        TriggerServerEvent("BTF:depositGangBalance", amount)
                    end
                else
                    tBTF.notify("~r~No amount entered!")
                end
            end
        else
        ...
        if CursorInArea(0.4083, 0.4718, 0.5490, 0.5999) then
            ...
            if IsControlJustPressed(1, 329) or IsDisabledControlJustPressed(1, 329) then
                PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
                if closeToBarclays() then
                    TriggerServerEvent("BTF:depositAllGangBalance")
                end
            end
        else
            ...
            if IsControlJustPressed(1, 329) or IsDisabledControlJustPressed(1, 329) then
                ...
                if amount ~= nil then
                    if gangPermission >= 3 then
                        if closeToBarclays() then
                            TriggerServerEvent("BTF:withdrawGangBalance", amount)
                        end
                    else
                        tBTF.notify("~r~You don't have a high enough rank to withdraw")
                    end
                else
                    tBTF.notify("~r~No amount entered!")
                end
        ...
        if CursorInArea(0.6088, 0.6739, 0.5481, 0.6018) then
            ...
            if IsControlJustPressed(1, 329) or IsDisabledControlJustPressed(1, 329) then
                ...
                if gangPermission >= 3 then
                    if closeToBarclays() then
                        TriggerServerEvent("BTF:withdrawAllGangBalance")
                    end
                else
                    tBTF.notify("~r~You don't have a high enough rank to withdraw")
                end
    ...
    if showMembersGangUI then 
        ...
        DrawRect(0.501,0.308,0.421,0.047,255,255,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"BTF Gang - Members",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("BTF:PromoteUser",gangID,tonumber(selectedMember))
                    else 
                        tBTF.notify("~r~You don't have permission to promote!")
                    end 
                else 
                    tBTF.notify("~r~No gang member selected")
                end 
            end 
        else 
        ...
        if CursorInArea(0.6182,0.6822,0.4138,0.4694)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("BTF:DemoteUser",gangID,selectedMember)
                    else 
                        tBTF.notify("~r~You don't have permission to demote!")
                    end 
                else 
                    tBTF.notify("~r~No gang member selected")
                end 
                ...
                if selectedMember~=nil then 
                    if gangPermission>=3 then 
                        if YesNoConfirm()then 
                            TriggerServerEvent("BTF:kickMemberFromGang",gangID,selectedMember)
                        end 
                    else 
                        tBTF.notify("~r~You don't have permission to kick!")
                    end 
                else 
                    tBTF.notify("~r~No gang member selected")
                end 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if s~=nil then 
                    if gangPermission>=2 then 
                        TriggerServerEvent("BTF:InviteUserToGang",gangID,s)
                    else 
                        tBTF.notify("~r~You don't have permission to invite players")
                    end 
                else 
                    tBTF.notify("No player name entered")
                end 
            end 
        else 
        ...
        if CursorInArea(0.3281,0.3723,0.6768,0.7074)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                PlaySound(-1,"SELECT","HUD_FRONTEND_DEFAULT_SOUNDSET",0,0,1)
                if e<=1 then 
                    tBTF.notify("~r~Lowest page reached")
                else 
                    e=e-1 
                end 
            end 
        ...
        if CursorInArea(0.4130,0.4572,0.6712,0.7064)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                PlaySound(-1,"SELECT","HUD_FRONTEND_DEFAULT_SOUNDSET",0,0,1)
                if e>=f then 
                    tBTF.notify("~r~Max page reached")
                else 
                    e=e+1 
                end 
            end 
    ...
    if showLogsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,255,255,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"BTF Gang - Logs",255,255,255,255,7,0)
    ...
    if showSettingsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,255,255,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"BTF Gang - Settings",255,255,255,255,7,0)
        ...
        if CursorInArea(0.3187,0.3937,0.4712,0.5462)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                PlaySound(-1,"SELECT","HUD_FRONTEND_DEFAULT_SOUNDSET",0,0,1)
                if YesNoConfirm()then 
                    TriggerServerEvent("BTF:memberLeaveGang",gangID)
                    setCursor(0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if gangPermission>=4 then 
                    if YesNoConfirm()==true and gangID~=nil then 
                        TriggerServerEvent("BTF:DeleteGang",gangID)
                    end 
                else 
                    tBTF.notify("~r~You don't have permission to disband!")
                end 
            end 
        else 
    ...
    --     DrawRect(0.501,0.308,0.421,0.047,255,255,0,248)
    --     DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"BTF Gang - Turfs",255,255,255,255,7,0)
    ...
    if showGangUI then 
        ...
        DrawRect(0.501,0.396,0.375,0.046,255,255,0,255)
        DrawAdvancedText(0.591,0.399,0.005,0.0028,0.51,"BTF Gangs",255,255,255,255,7,0)
...
RegisterNetEvent("BTF:Notify",function(u)
    tBTF.notify(u)
end)
...
function closeToBarclays()
    ...
    if w<10.0 or x<10.0 or z<10.0 then 
        ...
        tBTF.notify("~r~You must be near Barclays to access gang funds.")
        return false 
    end 
end
