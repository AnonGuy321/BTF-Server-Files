...
cfg.weapons = {
    ...
    ["WEAPON_SPACEFLIGHTMP5"] = {
        name = "SpaceFlight SMG",
        class = "SMG",
        ammo = "9mm Bullets",
        policeWeapon = false,
        model = "w_ar_SPACEFLIGHTMP5",
        showonback = true,
        weight = 10,
    },
    ["WEAPON_NEONOIRMAC10"] = {
