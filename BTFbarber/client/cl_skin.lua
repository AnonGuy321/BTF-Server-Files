...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("BTF:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("BTF:setHairstyle")
AddEventHandler("BTF:setHairstyle",function(hairstyle)
    if hairstyle then
...
local BTFFaceDataBlips = {
	...
	{128.09846496582,-1038.2600097656,29.555467605591},
...
Citizen.CreateThread(function()
	...
	for k, v in pairs(BTFFaceDataBlips) do
