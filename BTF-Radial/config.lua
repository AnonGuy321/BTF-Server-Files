...
RegisterNetEvent("BTF:PoliceClockedOn")
AddEventHandler("BTF:PoliceClockedOn", function(MetPD)
    onduty = MetPD
end)
...
rootCarMenuConfig =  {
    {
        ...
        subMenus = {"vehmenu:openboot", "vehmenu:lockcar","vehmenu:repaircar","vehmenu:lockpick","vehmenu:cleancar"}
    },
    {
        id = "police-action",
        ...
        subMenus = {--[['vehmenupd:openboot',]]'vehmenupd:clampveh','vehmenupd:unclampveh'}
    },
}
...
rootInCarMenuConfig =  {
    {
        ...
        subMenus = {"vehmenu:lockcar","vehmenu:repaircar","vehmenu:lockpick","vehmenu:cleancar"}
    },
    {
        id = "police-action",
...
rootMenuConfig =  {
    {
        ...
        subMenus = { "general:askid", "general:searchnearest", 'general:givemoney', 'general:cpr'}
    },
    {
        id = "police-action",
...
newSubMenus = {
    ...
    --     functionName = "BTFVeh:lockcar"
    -- },
    -- ['vehmenu:repaircar'] = {
    --     title = "Repair Vehicle",
    --     icon = "#general-check-vehicle",
    --     functionName = "BTF:ComingSoon"
    -- }, 
    ['vehmenu:lockpick'] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "BTF:LockPick2"
    },
    ['vehmenu:cleancar'] = {
        title = "Clean Your Vehicle",
        icon = "#general-keys-give",
        functionName = "BTF:CleanCar"
    },

    ['police:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
        functionName = 'BTF:reviveRadial'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "BTF:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "BTF:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "BTF:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "BTF:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "BTF:SearchPlr"
    },
    ['general:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
...
--[[     ['general:checkvehicle'] = {
    ...
    ['general:putinvehicle'] = {
        ...
        functionName = "BTF:PutPlrInVeh"
    },
    ['general:unseatnearest'] = {
        title = "Unseat Nearest",
        icon = "#general-unseat-nearest",
        functionName = "BTF:TakeOutOfVehicle"
    },    
    ['general:flipvehicle'] = {
        title = "Flip Vehicle",
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'BTF:JailPlayer'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "BTF:UnJailPlayer"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'BTF:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'BTF:SeizeWeapons2'
    }, 
--[[     ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'BTF:SeizeWeapons'
    },  ]]
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
