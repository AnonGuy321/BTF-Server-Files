...
RMenu.Add('policelarge', 'main', RageUI.CreateMenu("", "~b~BTF Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "sub", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~BTF Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~BTF Police Armoury", 1300, 50, "banners", "police"))
