...
RegisterNetEvent('BTF:TakenTurf')
AddEventHandler('BTF:TakenTurf', function(isnTurf)
...
RegisterNetEvent('BTF:OutOfZone')
AddEventHandler('BTF:OutOfZone', function(isnTurf)
	inTurf = false

	-- TriggerEvent('chatMessage', '[BTF Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you will receive nothing.")
...
RegisterNetEvent('BTF:PlayerDied')
AddEventHandler('BTF:PlayerDied', function(isnTurf)
	inTurf = false
	-- TriggerEvent('chatMessage', '[BTF Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you died!")
...
RegisterNetEvent('BTF:TurfComplete')
AddEventHandler('BTF:TurfComplete', function(reward, name)
	inTurf = false
	-- TriggerEvent('chatMessage', '[BTF Turf System]:', {255, 34, 0}, "Turf capture sucessful, you received:^2 £" .. reward)
...
function takeComis()
	Citizen.CreateThread(function() 
		while true do
			if doneIt then
				local v1 = vector3(-1115.0324707031,4936.4936523438,218.37245178223)
				
					if isInTurf == false then
					if isInArea(v1, 1.4) then 
						alert('~r~Press ~INPUT_VEH_HORN~ to Change Commision')
...
Citizen.CreateThread(function()
	while true do
		...
		DrawMarker(24, -1111.6334228516,4936.638671875,218.38676452637+1 - 0.98, 0.8, 0.8, 0, 0, 0, 0, 1.0, 1.0, 0.8, 255, 34, 0, 200, 0, true, 0, 0, 0, 0, 0)
		...
		if doneIt then
			DrawMarker(30, -1114.4342041016,4936.3017578125,218.37658691406+1 - 0.98, 0.8, 0.8, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0, 34, 255, 200, true, true, 0, 0, 0, 0, 0)
		end
