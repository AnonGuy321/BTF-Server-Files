main = {
    addPercentage = 0, -- This allows a 10% lee-way before classing the driver as speeding, set to 0 to disable
    ...
    webhook = "https://discord.com/api/webhooks/924789921292623873/5c1KF_iwJvCCu3brTIgXwOrX1D8E-IlcrYzqqdWQhY6uC7BEDDcr_QdsJvaPaAzYY8M6",
