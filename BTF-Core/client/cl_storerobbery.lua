...
TriggerEvent('BTF:RobberyBlip', bank, false)
...
AddEventHandler('es_bank:currentlyrobbing', function(robb)
	...
	--TriggerEvent('BTF:RobberyBlip', bank, true)
end)
...
AddEventHandler('es_bank:toofarlocal', function(robb)
	robbing = false
	TriggerEvent('chatMessage','Store Robbery │', {255, 255, 255}, "The robbery was cancelled, you will receive nothing.", "ooc")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
	--TriggerEvent('BTF:RobberyBlip', bank, false)
...
AddEventHandler('es_bank:playerdiedlocal', function(robb)
	robbing = false
	TriggerEvent('chatMessage','Store Robbery │', {255, 255, 255}, "The robbery was cancelled, you died!.", "ooc")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
	--TriggerEvent('BTF:RobberyBlip', bank, false)
...
AddEventHandler('es_bank:robberycomplete', function()
	robbing = false
	TriggerEvent('chatMessage','Store Robbery │', {255, 255, 255}, "Robbery done, you received the cash from the safe.", "ooc")
	bank = ""
	secondsRemaining = 0
	incircle = false
	--TriggerEvent('BTF:RobberyBlip', bank, false)
