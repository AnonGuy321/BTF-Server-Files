var config = {
  'title': '',
  'welcomeMessage':'BTF British RP',
  // Add images for the loading screen background.
  images: [
    'https://i.imgur.com/mfgbkIB.png', 'https://BTFforums.com/images/fivem/bg2.jpg', 'https://BTFforums.com/images/fivem/bg3.jpg',  
  ],
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/BTF5M',
  },
...
var gettingstarted = [
  'Welcome to BTF',
  'The world of BTF is pretty huge so it can be a little overwhelming at first! Here\'s a couple things you can do to get started and work you way up in the world:',
  '',
...
var generalhotkeys = [
  ...
  'Press <kbd>F5</kbd> to open the BTF Gang Menu',
...
var rphotkeys = [
  ...
  'Use <code>/th</code> to take someone hostage',
