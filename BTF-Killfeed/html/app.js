...
function newDeath(killed, style) {
    $('<div class="' + style + '"><span class="killer">' + killed + '</span><img src="img/weapon_unarmed.webp" class="weapon"><span class="killed">' + killed + '</span></div><br class="clear">').appendTo('.kills')
    .css({'margin-right':-$(this).width()+'px'})
    .animate({'margin-right':'0px'}, 'slow')
    .delay(5000)
    .animate({'margin-right':-$(this).width()+'px'}, 'slow')
