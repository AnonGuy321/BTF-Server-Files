...
zones = {
    ...
    {name = "Weed", coords =  vector3(108.45377349854,-1943.3997802734,20.803728103638), blipWidth = 35.0, blipColour = 1},
    {name = "Rust", coords =  vector3(2015.3059082031,2790.7751464844,50.305732727051), blipWidth = 90.0, blipColour = 1},
}
